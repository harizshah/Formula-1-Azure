...
merge_delta_data(final_df, 'hariz_f1_presentation', 'race_result', presentation_folder_path, merge_condition, 'race_id')
...
# MAGIC FROM hariz_f1_presentation.race_result
